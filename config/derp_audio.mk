...
ALARM_PATH := vendor/akxne/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/akxne/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/akxne/prebuilt/common/media/audio/ringtones
